...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/proffesor/details/*").hasAuthority("ROLE_PROFESSOR")
                .antMatchers("/proffesor/details/*").hasAuthority("ROLE_ADMIN")
                .antMatchers("/proffesor/edit/*").hasAuthority("ROLE_PROFESSOR")
                .antMatchers("/proffesor/edit/*").hasAuthority("ROLE_ADMIN")
